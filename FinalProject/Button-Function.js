...
$(document).ready(function(e)
{
  ...
  // calculate the position of the mouse when the cursor is moving
  ...
  // create inverted width and height for normalized positions inside the
  ...
  // take care of buttons and register events to it
...
function registerUserInput()
{
  ...
  // attach call back to mouse
  $(document).mousemove(mouseCallback);
  
  // attach call back to buttons
